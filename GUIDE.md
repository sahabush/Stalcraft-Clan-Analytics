...
⚠️ Важно: SCA — это инструмент сбора данных, а не оценка боевых качеств. Цифры не показывают, кто держал точку, командовал отрядом
или кидал решающие гранаты. Они лишь помогают заметить аномалии в общей картине.
---
...
### ⚠️ ВАЖНО: Оплата только реальными деньгами

**Категорически запрещено** оплачивать доступ к сервису внутриигровыми средствами (игровой валютой, предметами, артефактами, рекламой в нике и т.д.). Это является прямым нарушением **пользовательского соглашения Stalcraft** и может привести к **блокировке вашего аккаунта**.

> 💬 *"Но я могу задонатить на ник А_в_глаз?"*  
> Вы можете сделать добровольное пожертвование в игре, но **это не даёт вам доступ к сервису**. Доступ предоставляется **исключительно** после оплаты реальными рублями через официальные платёжные шлюзы.

Мы заботимся о безопасности ваших аккаунтов и строго соблюдаем правила игры.
