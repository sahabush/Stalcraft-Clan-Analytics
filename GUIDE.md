...
5. Если всё верно, вы увидите сообщение по типу:
...
|-------------|---------------|
| ![Правильный скриншот](images/correct_screenshot.png) | ![Неправильный скриншот](images/wrong_screenshot.png) |
...
![Результат OCR](images/ocr_result.png)
...
![Полная таблица](images/table_full.png)
...
/table days:30 mode:📱 По страницам
...
![Статистика игрока](images/player_stats.png)
