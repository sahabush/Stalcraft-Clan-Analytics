...
> 💡 **Совет:** Используйте `/player` перед важными играми, чтобы оценить форму бойцов!
...
Да! Используйте `/table` для постраничного просмотра (удобно на маленьких экранах) или `/table_full` для просмотра всех игроков сразу.
...
Если у вас остались вопросы, обнаружили ошибку или хотите предложить улучшение:
